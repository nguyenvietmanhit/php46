    ...
    <div class="highlight-carousel slider-carousel">
        ...
        <div class="owl-carousel owl-loaded owl-drag" id="postCarousel">
            ...
            <div class="owl-stage-outer">
                <div class="owl-stage"
                     style="transform: translate3d(-2360px, 0px, 0px); transition: all 0s ease 0s; width: 9440px;">
                    <div class="owl-item cloned" style="width: 1160px; margin-right: 20px;">
                        <div class="item">
                    ...
                    <div class="owl-item active" style="width: 1160px; margin-right: 20px;">
                        <div class="item">
                            ...
                            <article class="post-box"
                                ...
                                <div class="post-overlay">
                                    <a href="#" class="post-category" title="Title of blog post" rel="tag">Thể thao</a>
                                    <h3 class="post-title">Facebook: Cambridge Analytica may have accessed some users’
                                        private
                                        messages</h3>
                                    <div class="post-meta">
                                        <div class="post-meta-author-avatar">
                    ...
                    <div class="owl-item" style="width: 1160px; margin-right: 20px;">
                        <div class="item">
            ...
            <div class="owl-nav">
                <button type="button" role="presentation" class="owl-prev"><span><i class="material-icons"></i></span>
                </button>
                <button type="button" role="presentation" class="owl-next"><span><i class="material-icons"></i></span>
                </button>
            </div>
            <div class="owl-dots">
    ...
    <div class="main-content">
        <div class="main-content-wrapper container">
            ...
            <p class="footer-copyright">
                Copyright 2019 by Suntiin. All rights reserved
            </p>
        </div>
    </div>
</div>
